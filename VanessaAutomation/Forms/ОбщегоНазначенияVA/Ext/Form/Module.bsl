...
Функция КоллекцияКомандЗапуска() Экспорт
	...
	КоллекцияКоманд.Вставить("ПриводитьОтступыПриСохранении", Новый Структура("Р, А", "ПриводитьОтступыПриСохранении", "normalizeindentationonsave"));
	КоллекцияКоманд.Вставить("РазмерТабуляции", Новый Структура("Р, А", "РазмерТабуляции", "tabsize"));
